...
ERNO.Cube = function (parameters) {
	...
	([
		...
		[R, Y, , , B,], [R, Y, , , ,], [R, Y, G, , ,],//   0,  1,  2 U
		[R, , , , B,], [R, , , , ,], [R, , G, , ,],//   3,  4,  5 M层
		[R, , , W, B,], [R, , , W, ,], [R, , G, W, ,],//   6,  7,  8 D层
		//  Standing slice
		[ , Y, , , B,], [, Y, , , ,], [, Y, G, , ,],//   9, 10, 11
		[ , , , , B,], [, , , , ,], [, , G, , ,],//  12, XX, 14
		[ , , , W, B,], [, , , W, ,], [, , G, W, ,],//  15, 16, 17
		//  Back slice
		[ , Y, , , B, O], [, Y, , , , O], [, Y, G, , , O],//  18, 19, 20
		[ , , , , B, O], [, , , , , O], [, , G, , , O],//  21, 22, 23
		[ , , , W, B, O], [, , , W, , O], [, , G, W, , O] //  24, 25, 26

	]).forEach(function (cubeletColorMap, cubeletId) {
    // console.log(cubeletId,cubeletColorMap)
    //学习点:生成cubelet
    this.showCode= parameters.showCode === undefined ? false : parameters.showCode;
    this.showLayer= parameters.showLayer === undefined ? "--" : parameters.showLayer;
    this.showType= parameters.showType === undefined ? "edge" : parameters.showType;
