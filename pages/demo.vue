  ...
  <el-dialog v-model="dialogFormVisible" destroy-on-close title="公式编辑">
      ...
      >
          <el-form-item label="Password" prop="Name">
              <el-input v-model="rowCFOP.Name" type="password" autocomplete="off" />
          </el-form-item>
          <el-form-item label="Confirm" prop="Code">
              <el-input
                  v-model="rowCFOP.Code"
                  type="password"
                  autocomplete="off"
              />
          </el-form-item>
          <el-form-item label="Age" prop="Formula">
              <el-input v-model.number="rowCFOP.Formula" />
          </el-form-item>
          <el-form-item>
...
//校验规则组合
const rules1 = reactive<FormRules<typeof rowCFOP>>({
...
const rules = reactive<FormRules<rowCFOP>>({
  Name: [
