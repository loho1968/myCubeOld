    ...
    <el-dialog v-model="dialogFormVisible" destroy-on-close title="公式编辑">
        ...
        >
            <el-form-item label="类型" prop="Type">
                <el-select v-model="rowCFOP.Type" placeholder="必须设置类型">
            ...
            <el-form-item label="助记码" prop="ThinkCode">
                <el-input v-model="rowCFOP.ThinkCode" autocomplete="off" />
            </el-form-item>
            ...
            <el-form-item label="镜像公式编码">
                <el-input v-model="rowCFOP.MirrorCode" autocomplete="off" />
            </el-form-item>
            <el-form-item label="镜像公式" size="large">
                <el-input v-model="rowCFOP.MirrorFormula" autocomplete="off" />
            </el-form-item>
        </el-form>
        <template #footer>
...
const pageSize = usePageSizeStore(); //每页行数
let dialogFormVisible = ref(false); //编辑公式弹窗显示控制变量
let allFormulaCode = ""; //所有公式编码

//#region 公式数据对象
let cfopList: CFOP[] = [];
let rowCFOP = ref<CFOP>({
    Type: string,
    Formula: string | null,
    OtherFormula: string | null,
    ID: string,
    Name: string | null,
    Code: string | null,
});
...
const rowClick = (row) => {
    ...
    CreateFormulaDisplay("mirror", reserveFormula.Formula, colored);
};
