...
const obj_0_1_2={"00":"B", "01":"A","04":"C","10":"B","11":"A","20":"L","21":"J","22":"K"};
const obj_3_4_5={"30":"S","34":"T","40":"F","50":"Q","52":"R"};
const obj_6_7_8={"60":"N","63":"W","64":"M","70":"J","73":"I","80":"Y","82":"Z","83":"X"};
const obj_9_10_11={"91":"C","94":"D","101":"U","111":"G","112":"H"};
const obj_12_14={"124":"L","142":"R"};
const obj_15_16_17={"153":"K","154":"L","163":"D","172":"Z","173":"X","175":"Y"};
const obj_18_19_20={"181":"D","184":"E","185":"F","191":"E","195":"F","201":"G","202":"I","205":"H"};
const obj_21_22_23={"214":"X","215":"W","225":"B","232":"Z","235":"Y"};
const obj_24_25_26={"243":"O","244":"Q","245":"P","253":"M","255":"N","262":"S","263":"R","265":"T"};

const cubeletCode={}
Object.assign(cubeletCode,obj_0_1_2,obj_3_4_5,obj_6_7_8,obj_9_10_11,obj_12_14,obj_15_16_17,obj_18_19_20,obj_21_22_23,obj_24_25_26);

// const ULayer=",0,1,2,9,10,11,18,19,20,";
// const MLayer=",3,4,5,12,14,";
// const DLayer=",6,7,8,15,16,17,24,25,26,";
...
ERNO.Cubelet = function (cube, id, colors) {
  ...
  for (var i = 0; i < 6; i++) {
    ...
    //  and also allow text to be placed on it.
      ...
      //学习点:生成code
      if(cube.showCode){
        this.faces[i].code=cubeletCode[`${id}${i}`];
        this.faces[i].showLayer=cube.showLayer;
        this.faces[i].showType=cube.showType;
      }
